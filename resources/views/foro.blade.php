...
<body>
    ...
    <body>
        <form enctype="multipart/form-data" id="formulario" class="formulario was-validated" method="POST">
            <div id="editor"></div>
            ...
            <div class="mb-3 row form-box">
                ...
                <div class="col-sm-10">
                    <input class="form-control" name="titulo" id="exampleFormControlTextarea1" required
            ...
            <div class="mb-3 form-box">
                ...
                <select class="form-select" required aria-label="select example" name="tipo">
            ...
            <div class="mb-3 row form-box">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="descripcion" id="exampleFormControlTextarea2" required
            ...
            <div class="ui-input">
                <label class="col-sm-2 col-form-label" for="nombre" name="archivo">Añadir archivo adjunto: </label>
                <input type="file" id="miInput">
            </div>

            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button class="btn btn-primary me-md-2" id="submit" type="submit" name="registro">Crear foro</button>
