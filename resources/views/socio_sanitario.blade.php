...
<ul> <h5>INDICE</h5> 
    ...
    <li>¿Qué es auxiliar sociosanitario?</li>
    <li>Labores que debes desempeñar </li>
    <li>Otras atenciones que debes de monitorear</li>
...
<img src="img/soi1.jpg" width="1350px" height="400px" alt="">
    <div class="row py-4">
        ...
        <p>
        El programa de preparación e inducción está dirigido a todas las personas que quieran contribuir a la protección y cuidado de aquellas personas que lo necesitan, el cual puedes hacerlo o formar parte de una forma altruista y desinteresada. <br>

        Los conocimientos que te bridaremos aquí mismo te permitirán recibir la aprobación para que puedas formar parte de voluntariado sociosanitario, con esta aprobación estarás ya calificado para que puedas colabora en las diferentes áreas que esta categoría de voluntariado te ofrece, así como te brindara una experiencia única con aquellas personas que estén bajo tu cargo, así como tambien con el tiempo iras aprendiendo de ellas mismas cosas nuevas que te servirán en tu desempeño. <br>

        En el programa tambien te damos consejos los cuales te podrán servir mucho para tu adaptación, las organizaciones solidarias necesitamos de personas con iniciativa de ayudar a otros, por lo cual es nuestro deber de que en este programa seas consciente de que puedes enfrentarte en algunos momentos difíciles cuando estés realizando tu trabajo, de igual forma sabemos que serás muy bien recibido por aquellas personas que necesitan jóvenes solidarios como tú por ello, valoramos tu iniciativa y al final del día estés satisfecho con tus acciones para con los que necesitan de ti.
        ...
        En el material te damos a conocer sobre las labores que deberás realizar cuando estés en servicio, tambien diferentes problemas que puedan surgen mediante realizas este servicio, así como diferentes acciones que deberás hacer en base a la persona que este bajo tu cuidado, ya que estas deberás de realizarlas día con día por lo que se convertirán en una rutia constante que debes realizar con responsabilidad. 
        Además, te proporcionamos material ilustrativo con el cual se te facilitara comprender el contenido y como consecuencia las acciones o atenciones que deberás de realizar a la hora de realizar tu servicio, por lo que esperamos que lo adquieras con muchas iniciativa y responsabilidad para que puedas ser uno más de nuestros héroes.  
        ...
        <div class="row py-4">
        <h5>¿Qué es un auxiliar sociosanitario?</h5> <br>

        <p>
        Es fundamentalmente, aquella persona encargada de ayudar en las actividades básicas de la vida diaria a otras que, por razones de edad, enfermedad y/o discapacidad no pueden realizar estas funciones por sí mismas.
        </p>
        ...
        <div class="row py-4">
        <h5>LABORES QUE DEBES DESEMPEÑAR</h5> <br>
        ...
        <div class="col">
            ...
            <div class="card-body">
                ...
                Alimentos que no se recomienda tenemos lo siguientes: <br>

                tomate (fresco), frutos secos, chocolate, uva, plátanos, frutos cítricos, salazones entre otros. <br>
                Entre los alimentos que se recomienda tenemos: <br>  
                Aceite de oliva, pasta (macarrones, espagueti, arroz), carne magra, pescado, fruta máximo 2 piezas al día (preferiblemente manzana, pera o sandia). 
                Ocasionalmente puede sustituir una de las piezas por otra fruta a excepción de plátano, melón o uva, fruta en almíbar (retirando el caldo), lácteos desnatados, no más de 2 al día (leche o yogur).
        ...
        <div class="col">
            ...
            <div class="card-body">
                ...
                pasta, arroz, pan blanco, verduras cocidas y sin piel, patata, frutas cocidas, carnes magras, pescados, clara de huevo, productos lácteos desnatados, agua y bebidas sin cafeína. Los alimentos se deben preparar hervidos, al horno, a la plancha o al grill, evitando las frituras. <br>
        ...
        <div class="col">
            ...
            <div class="card-body">
                ...
                Y entre las frutas y vegetales que debes limitarle tenemos: Coco, vegetales con salsas cremosas, vegetales fritos o empanados, frutas enlatadas envasadas con almíbar espeso, frutas congeladas con azúcar agregado. Tambien debes de limitar la ingesta de grasas no saludables, así como reducir el sodio en tus comidas.
        ...
        <div class="col">
          ...
          <div class="row py-4">
        <h5>Otras atenciones que debes de monitorear</h5> <br>
        ...
        <div class="col">
          ...
          <div class="row py-4">
        <h5>Actitudes y valores con las que debes de contar</h5> <br>
        ...
        <div class="col">
          ...
          <div class="row py-4">
        <h5>Habilidades sociales con las que debes de contar</h5> <br>
        ...
        <div class="col">
            ...
            <div class="card-body">
                ...
                que tienen una mayor experiencia en esta área, ya que aprenderás mucho con solo escuchar.
                </p>
            </div>
            </div>
        </div>
        ...
        <div class="col">
          ...
          <div class="row py-4">
        <h5>Responsailidades especificas</h5> <br>
    ...
    <h3>PAGINAS WEB VOLUNTARIADO SOCIO-SANITARIO</h3>

    <p>Te damos los enlaces de las páginas o videos donde puedes infórmate más sobre el voluntariado <br>
     sociosanitario para poder convertirte en un héroe voluntario dedicado a proteger y ayudar a los que <br> 
     lo necesitan, se te presentan muchos temas de interés donde podrás adquirir más conocimientos para que puedas <br>
     desarrollar las actividades de un voluntario sociosanitario.</p>

        <p>
        <h5>¿Qué es la atención sociosanitaria?</h5>
        <a href="https://www.elrincondelcuidador.es/blog/atencion-sociosanitaria/"target="_blank">Ir al sitio</a>
        <br>
        <h5>Personas dependientes</h5>
        <a href="https://psicologiaymente.com/salud/atencion-sociosanitaria-a-personas-dependientes"target="_blank">Ir al sitio</a>
        <br>
        <h5>Como es la ayuda domicilio</h5>
        <a href="https://www.msolucionaalcobendas.com/tecnico-sociosanitario-funciones-la-ayuda-domicilio/"target="_blank">Ir al sitio</a>
        <br>
        <h5>Material didáctico a personas dependientes</h5>
        <a href="http://www.formacionyempleo.ugt-andalucia.com/tablon/9-material-didactico-sobre-atencion-sociosanitaria-a-personas-dependientes-en-instituciones-sociales"target="_blank">Ir al sitio</a>
        <br>
        <h5>Prevención de riesgo aplicado en empresas sociosanitarias</h5>
        <a href="https://www.geriatricarea.com/2015/05/12/prevencion-de-riesgos-laborales-en-empresas-sociosanitarias/"target="_blank">Ir al sitio</a>
        <br>
        <h5>Recomendaciones</h5>
        <a href="https://youtu.be/DtH0VuxppfU"target="_blank">Ir al sitio</a>
        <br>
        </p>
    </div>
