        ...
        <div class="w3-content">
            ...
            <div class="w3-twothird">
                ...
                <ul>
                    ...
                    <li>
                        <h5 class="w3-padding-32">Segundo</h5>
                        <p class="w3-text-grey">Guardar, cuando proceda, confidencialidad de la información recibida
                            yconocida en el desarrollo de su actividad voluntaria.</p>
                    </li>

                    <li>
                        <h5 class="w3-padding-32">Tercero</h5>
                        <p class="w3-text-grey">Rechazar cualquier contraprestación material que pudieran recibir bien
                            del beneficiario/a o de otras personas relacionadas con su acción.</p>
                    </li>
            ...
            <div class="w3-twothird">
                ...
                <ol>
                    <li>
                        ...
                        <p class="w3-text-grey">Cuando te conviertes en voluntario o voluntaria te sientes útil. Te das
                    ...
                    <li>
                        ...
                        <p class="w3-text-grey">¿Te gusta trabajar con otras personas, codo con codo, sumando fuerzas,
                            ...
                            te conviertes en voluntario o voluntaria de una organización de tu comunidad conoces gente
                            diferente y aprendes a sumar esfuerzos para conseguir un objetivo. ¡Quizás haciendo
                            voluntariado harás buenos amigos y amigas!.</p>
                    </li>
                    ...
                    <li>
                        ...
                        <p class="w3-text-grey">No es lo mismo aprender de un libro que de la vida real. Cuando haces
                            voluntariado te sumerges en la experiencia y aplicas tus conocimientos y capacidades. Añade
                            tu experiencia de voluntariado en el CV o currículo, las empresas o ONGs por las que te
                            gustaría trabajar seguro que valoraran positivamente todo lo que has aprendido siendo
                            voluntario/a.</p>
                    </li>
                    ...
                    <li>
                        ...
                        <p class="w3-text-grey">Las personas vivimos en sociedad, es nuestra naturaleza. Cuando haces
                            ...
                            por los problemas sociales. Comprométete como voluntario o voluntaria para comprender el
                            mundo y enriquecer tu punto de vista.</p>
                    </li>

                    <li>
                        <h5 class="w3-padding-32">Mejorar tu autoestima y generosidad</h5>
                        <p class="w3-text-grey"> Convertirse en voluntario/a quiere decir implicarse, sentirse útil,
                            ...
                            suavizar el egocentrismo que reina en nuestras vidas y ser más generosos/as.</p>
                    </li>
                    ...
                    <li>
                        ...
                        <p class="w3-text-grey">Según recientes estudios científicos, el trabajo voluntario mejora
                            nuestra salud física y mental, baja la tasa de mortalidad, disminuye el riesgo de depresión
                            y otras enfermedades mentales, mejora los niveles de colesterol y la salud cardiovascular,
                            entre otros. Además, estos beneficios para la salud se verán potenciados si nuestras tareas
                            como voluntaria o voluntario incluyen actividades físicas como se puede dar en algunos tipos
                            de voluntariado como en el voluntariado deportivo, ambiental, de ocio y tiempo libre, de
                            protección civil o el voluntariado cultural.</p>
                    </li>
                    ...
                    <li>
                        ...
                        <p class="w3-text-grey">¿Quieres cambiar el mundo? ¿Poner tu granito de arena para que mejoren
                            las cosas? ¿Para acabar con el sufrimiento y la injusticia? Haciéndote voluntario o
                    ...
                    <li>
                        ...
                        <p class="w3-text-grey">¿Tienes muy claros tus valores ideológicos o religiosos y quieres
                            ponerlos en práctica? Cuando eres voluntario o voluntaria te rigen valores como la
                            generosidad, la solidaridad, el altruismo, la sostenibilidad, la justicia, la fraternidad,
                            la empatía, los derechos humanos, la igualdad, la libertad, la honestidad, la tolerancia, la
                            sinceridad, la utopía….</p>
                    </li>

                    <li>
                        <h5 class="w3-padding-32">Proteger la naturaleza</h5>
                        <p class="w3-text-grey">¿Te duele ver como se está deteriorando nuestro planeta? Hacerte
                            voluntario de una organización que desarrolle programas de voluntariado ambiental es una
                            manera de contribuir a la protección y cuidado del medio ambiente.</p>
                    </li>
